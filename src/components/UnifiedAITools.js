      ...
      showConfirm(
        ...
        () => {
          ...
          sendAICompleteNotification(
            `Your schedule with ${totalBlocksAdded} blocks has been created using ${modelLabel}`,
            totalBlocksAdded
          );
    ...
    try {
      ...
      showConfirm(
        ...
        () => {
          ...
          // Send notification that AI processing is complete
          sendAICompleteNotification(
            `Your calendar-based schedule with ${totalBlocksAdded} blocks has been created using ${modelLabel}`,
            totalBlocksAdded
          );
    ...
    try {
      ...
      showConfirm(
        ...
        () => {
          ...
          // Send notification that AI processing is complete
          sendAICompleteNotification(
            `Your optimized schedule with ${totalBlocksAdded} study blocks has been created using ${modelLabel}`,
            totalBlocksAdded
          );
